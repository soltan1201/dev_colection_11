...
data_remap = True
if data_remap:
    classes = [3,4,12,21,25,27,29,33,36]
    classNew =  [27, 3, 4, 3, 3, 3,12,12,12,21,21,21,21,21,25,25,25,25,33,29,25,33,12,33,21,33,33,21,21,21,21,21,21,21,21,21,21, 4,12,21,25]
else:
    classes = [3,4,12,15,19,21,25,27,29,33,36] # 
    classNew =  [27, 3, 4, 3, 3, 3,12,12,12,21,21,19,10,21,25,25,25,25,33,29,25,33,12,33,36,36,36,36,36,36,36,36,36,36,36,36,36, 4,12,36,25]
...
dict_class = {
    ...
    '12': 'Grassland', 
    '15': 'Pasture', 
    '19': 'Agriculture Temporaria', 
    '21': 'Mosaic of Uses', 
    '25': 'Non vegetated area', 
    '27': 'Not Observed', 
    '29': 'Rocky Outcrop', 
    '33': 'Water',
    '36': 'Agriculture Perenne',
}
...
if processCol9:
    ...
    version_process = ['1'] # '5','9','10','11', '12', '15''16', '17',18, '22', '25'
    modelos = posclass
